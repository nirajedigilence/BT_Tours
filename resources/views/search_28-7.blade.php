                                ...
                                <div class="checkAllBtn">
                                    <div class="left">
                                        <div class="round">
                                            ...
                                            <input type="checkbox" name="countries_id[]" <?=(in_array($country->id,$country_ar)?'checked':'')?> value="{{$country->id}}" class="<?=(in_array($country->id,$country_ar)?'allSelected':'')?>" id="checkbox-c-{{$country->id}}" />
                            ...
                            <div class="parentBox">
                                <div class="childrensBox">
                                    ...
                                    <div class="item">
                                        <div class="left">
                                            <div class="round">
                                                <input type="checkbox" name="experience_categories_id[]" class="{{strtolower($ec->name)}} ecatIdCls" value="{{$ec->id}}" id="checkbox-ec-{{$ec->id}}" @if ( isset($ec->selected) && $ec->selected) checked @endif>
