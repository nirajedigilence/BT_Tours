    ...
    <div class="container">
        <div class="headerRow">
            ...
            <div class="logoBox" style="width: 100%;float: left;">
                <a href="{{getenv('BT_SITE')}}/all-tours/public" class="logo">
             ...
             <div class="menuBox">
                ...
                <ul class="menu">
                    <li class="menuLi hasSubmenu">
                        <a class="menuLink" href="/all-tours/public/search">UK Tours</a>
                    ...
                    <li class="menuLi">
                        <a class="menuLink" href="/all-tours/public/search">Tours</a>
                    </li>
                    <li class="menuLi">
