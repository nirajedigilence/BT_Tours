                    ...
                    <div class="partOneCls">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="step5[carousel][{{ $cnts }}][title]" class="form-control" value="{{ $value->name }}" required="" data-msg-required="Please provide name">
                                    <input name="step5[carousel][{{ $cnts }}][id]" class="form-control" value="{{ $value->id }}" type="hidden">
                                </div>
                            </div>
                            
                        </div>
                        <div class="dropzone_test dropzone myDropZoneCls step5_carousel_{{ $cnts }}_img" data-name='step5[carousel][{{ $cnts }}][image][]' data-cls=".step5_carousel_{{ $cnts }}_img" >
                        ...
                        <div class="brw_bx image_galller">
                            <div class="browse_btn">
                                <?php if(isset($value->ExperiencesToGalleryImagesh)){ ?>
                                    <input type="file" class="filesCls" name="step5[carousel][{{ $cnts }}][image][]" data-id="2415{{ $cnts }}" multiple="" accept="image/*" <?php echo count($value->ExperiencesToGalleryImagesh) >= 1 ? '' : 'required'?>>
                                <?php } else{ ?>
                                    <input type="file" class="filesCls" name="step5[carousel][{{ $cnts }}][image][]" data-id="2415{{ $cnts }}" multiple="" accept="image/*">
                                <?php } ?>
                ...
                <div class="partOneCls">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="Category1">Strip/Carousel Name</label>
                                <input name="step5[carousel][1][title]" class="form-control" >
                            </div>
                        </div>
                        
                    </div>
                    <div class="imageGalllerAppend_1"></div>
                    <div class="dropzone_test dropzone myDropZoneCls step5_1_img" data-name='step5[carousel][1][image][]' data-cls=".step5_1_img" ></div>
                    {{-- <div class="brw_bx image_galller">
                        <div class="browse_btn">
                            <input type="file" class="filesCls" name="step5[carousel][1][image][]" data-id="1" multiple="" accept="image/*">
                            <div class="brw_user_ic">
                                <i class="far fa-images"></i>
                                <div class="brw_plus">
                                    <i class="fas fa-plus"></i>
                ...
                <div class="partOneCls">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="Category1">Strip/Carousel Name</label>
                                <input name="step5[carousel][2][title]" class="form-control" >
                            </div>
                        </div>
                        
                    </div>
                    <div class="imageGalllerAppend_2"></div>
                    <div class="dropzone_test dropzone myDropZoneCls step5_2_img" data-name='step5[carousel][2][image][]' data-cls=".step5_2_img" ></div>
                    {{-- <div class="brw_bx image_galller">
                        <div class="browse_btn">
                            <input type="file" class="filesCls" name="step5[carousel][2][image][]" data-id="2" multiple="" accept="image/*">
                            <div class="brw_user_ic">
                                <i class="far fa-images"></i>
                                <div class="brw_plus">
                                    <i class="fas fa-plus"></i>
        ...
        if(isset($experience)){
                    ...
                    <div class="carousel_div">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="step5[carouselnew][<?=$value->id?>][title]" id="step5Carousel-<?=$value->id?>" class="form-control" value="{{$value->name}}" >
                                <input name="step5[carouselnew][<?=$value->id?>][id]" class="form-control" value="{{ $value->id }}" type="hidden">
                            </div>
                        </div>
           ...
           <!--  <div class="carousel_div">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="Category1">Strip/Carousel Name</label>
                        <input name="step5[carouselnew]['+expCarouselRow+'][title]" id="step5Carousel-'+expCarouselRow+'" class="form-control" >
                    </div>
                </div>
                <div class="col-sm-12 gallary_img_div">
