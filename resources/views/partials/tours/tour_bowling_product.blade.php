...
<div class="middleCol completedBooking productsection" id="middleCol">
    <div class="">
        <?php 
        if(isset($experience)){ ?>
         {!! Form::open(array('route' => 'tour-bowling-update','method'=>'POST', 'enctype' => 'multipart/form-data', 'class'=>'tourCompleteSteps', 'id'=>'tourCompleteSteps')) !!}
        <?php } else{ ?>
         {!! Form::open(array('route' => 'tour-bowling-store','method'=>'POST', 'enctype' => 'multipart/form-data', 'class'=>'tourCompleteSteps', 'id'=>'tourCompleteSteps')) !!}
        <?php } ?>
        <div class="header_part">
            ...
            <div class="head_part_two" style="width: 50%;">
                ...
                <?php if(!empty($experience->id) && ($experience->active == 1)){ ?>
                    <a style="font-size: 16px;" target="_blank" class="orangeLink btn pullright" href="{{ route('bowling.show', @$experience->id) }}">Preview</a>
                <?php } ?>
            ...
            <div class="contentBooking experiencesMainSectionDiv">
                    ...
                    <div class="contentDiv" style="max-height: 1060px; overflow: auto;">
                        <div class="tourStep_1 tourStepCls" style="display: block;">
                            @include('partials.tours.complete_bowling.tourStep_1',[
                                    'current_step' => '1'
                            ])                        
                        </div>
                        <div class="tourStep_2 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_2',[
                                    'current_step' => '2'
                            ]) 
                        </div>
                        <div class="tourStep_3 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_3_Experiences',[
                                    'current_step' => '3'
                            ]) 
                        </div>
                        <div class="tourStep_4 tourStepCls" style="display: none">
                            @include('partials.tours.complete_bowling.tourStep_4_Hotel',[
                                    'current_step' => '4'
                            ]) 
                        </div>
                        <div class="tourStep_5 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_5_Gallery',[
                                    'current_step' => '5'
                            ]) 
                        </div>
                        <div class="tourStep_6 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_6_Map',[
                                    'current_step' => '6'
                            ]) 
                        </div>
                        <div class="tourStep_7 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_7_fixtures',[
                                    'current_step' => '7'
                            ]) 
                        </div>
                        <div class="tourStep_8 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_11_layout',[
                                    'current_step' => '8'
                            ]) 
                        </div>
						 <div class="tourStep_9 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_12_layout',[
                                    'current_step' => '9'
                            ]) 
                        </div>
						 <div class="tourStep_10 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_13_layout',[
                                    'current_step' => '10'
                            ]) 
                        </div>
                        ...
                        <div class="tourStep_11 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_8_layout',[
                                    'current_step' => '11'
                            ]) 
                        </div>
                        <div class="tourStep_12 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_9_layout',[
                                    'current_step' => '12'
                            ]) 
                        </div>
                        <div class="tourStep_13 tourStepCls" style="display: none;">
                            @include('partials.tours.complete_bowling.tourStep_10_layout',[
                                    'current_step' => '13'
                            ]) 
                        </div>
                    </div>
                ...
                <div class="rightSidebarDiv">
                    @include('partials.tours.complete_bowling.tour_standard_product_sidebar',[
                            'current_step' => '1'
                    ])    
                </div>
...
<script src="{{ asset('js/pages/tour_bowling.js') }}"></script>
<script>
