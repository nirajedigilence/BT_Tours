                            ...
                            <div class="page" >
                                ...
                                <div class="body">
                                    ...
                                    <div class="column">
                                        ...
                                        <div class="image">
                                            <?php if(isset($brochures->image_1) && str_contains($brochures->image_1,'data:image')){  ?>
                                                <img src="{{ isset($brochures->image_1) ? $brochures->image_1 : '' }}">
                                             <?php } else { ?> 
                                            <img src="/all-tours/public/proxy-image?url={{ isset($brochures->image_1) ? $brochures->image_1 : '' }}">
                                            <?php } ?>
                                        ...
                                        <div class="image">
                                            <?php if(isset($brochures->image_2) && str_contains($brochures->image_2,'data:image')){  ?>
                                                <img src="{{ isset($brochures->image_2) ? $brochures->image_2 : '' }}">
                                             <?php } else { ?> 
                                            <img src="/all-tours/public/proxy-image?url={{ isset($brochures->image_2) ? $brochures->image_2 : '' }}">
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="column">
                                        ...
                                        <div class="image">
                                            <?php if(isset($brochures->image_3) && str_contains($brochures->image_3,'data:image')){  ?>
                                                <img src="{{ isset($brochures->image_3) ? $brochures->image_3 : '' }}">
                                             <?php } else { ?> 
                                            <img src="/all-tours/public/proxy-image?url={{ isset($brochures->image_3) ? $brochures->image_3 : '' }}">
                                            <?php } ?>
...
DB::table('hotels')->where('id', $brochures->hotel_id)->first();
                                            ?>
