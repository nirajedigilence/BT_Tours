...
<table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
    <thead>
       <tr class="text-left border-b-2 border-gray-300">
            <th align="center" width="20" style="background-color:  #80b3e5;font-size:15px;border: 1px solid #000000;">IN</th>
            <th align="center" width="20" style="background-color:  #80b3e5;font-size:15px;border: 1px solid #000000;">OUT</th>
            ...
            <th align="center" width="30" style="background-color:  #80b3e5;font-size:15px;border: 1px solid #000000;">Package Name</th>
            ...
            <th align="center" width="30" style="background-color:  #80b3e5;font-size:15px;border: 1px solid #000000;">Package Link</th>
    ...
    <tbody> 
         ...
         foreach($items as $key => $item)
         {
            ...
            {
                if(in_array('1',$_GET['booking_type']))
                {
                ...
                {
                    if(in_array('2',$_GET['booking_type']))
                    {
                        if($item->completed == 0){
                            continue;
                        }
                ...
                if(in_array('3',$_GET['booking_type']))
                {
...
DB::connection('mysql_veenus')->table('attractions')->where('id', $expRow->attractions_id)->first();*/?>
            ...
            <tr class="border-b border-gray-200">
                    ...
                    <td align="center" valign="top" style="border: 1px solid #000000;">{{ $item->hotel_name }}</td>
                    <td align="center" valign="top" style="border: 1px solid #000000;">{{ isset($item->colobratorName) ? $item->colobratorName : '-' }}</td>
                    <td align="center" valign="top" style="border: 1px solid #000000;width: 300px;">{{ $item->experience_name }}</td>
                   
                  <?php /*  <td align="center" valign="top" style="border: 1px solid #000000;"></td>
