...
DB::connection('mysql_veenus')->table('hotel_dates')->select('h.id','h.name','h.street','h.city','h.country','h.postcode','h.phone')->leftjoin('hotels as h','h.id','=','hotel_dates.hotel_id')->where('hotel_dates.id', $value->hotel_date_id)->first();
                               ...
                               <?php $cartExperienceTP = App\Models\Cms\CartExpericenceTP::where("cart_exp_id", $cartid)->where("exp_date_id", $value->id)->first(); ?>
                               <?php if(!empty($cartExperienceTP->tp_eta)){ ?> 
                                <div class="tc_box_wrapper">
                                    <div class="tc_box">
                                        ...
                                        <div class="body">
                                            ...
                                            <textarea id="etaField{{$value->id}}" name="eta{{$value->id}}" class="form-control" style="display: none;">{{ isset($cartExperienceTP->tp_eta) ? preg_replace($pattern, '', ($cartExperienceTP->tp_eta)) : '' }} </textarea>
                                            <div id="etaContent{{$value->id}}">
                                                {!! isset($cartExperienceTP->tp_eta) ? $cartExperienceTP->tp_eta : '' !!}
                                ...
                                <?php } ?>
                               <?php if(!empty($cartExperienceTP->tp_etd)){ ?> 
                                <div class="tc_box_wrapper">
                                    <div class="tc_box">
                                        ...
                                        <div class="body">
                                            ...
                                            <textarea id="etdField{{$value->id}}" name="etd{{$value->id}}" class="form-control" style="display: none;">{{ isset($cartExperienceTP->tp_etd) ? preg_replace($pattern, '', ($cartExperienceTP->tp_etd)) : '' }}</textarea>
                                                <div id="etdContent{{$value->id}}">
                                                    {!! isset($cartExperienceTP->tp_etd) ? $cartExperienceTP->tp_etd : '' !!}
                                                </div>
                                ...
                                <?php } ?>
                                <?php if(!empty($cartExperienceTP->tp_mean_arrangements)){ ?> 
                                <div class="tc_box_wrapper">
                                        <div class="tc_box">
                                            ...
                                            <div class="body">
                                                <textarea id="mean_arrangementsField{{$value->id}}" name="tds_mean_arrangements{{$value->id}}" class="form-control" style="display: none;">{{ isset($cartExperienceTP->tp_mean_arrangements) ? preg_replace($pattern, '', ($cartExperienceTP->tp_mean_arrangements)) : '' }}</textarea>
                                                <div id="mean_arrangementsContent{{$value->id}}">
                                                     {!! isset($cartExperienceTP->tp_mean_arrangements) ? $cartExperienceTP->tp_mean_arrangements : '' !!}
                                ...
                                <?php } ?>
                                 <?php /*if(!empty($cartExperienceTP->tp_tour_inclusions)){ */ ?> 
                                <div class="tc_box_wrapper">
                                    <div class="tc_box">
                                        ...
                                        <div class="body">
                                            ...
                                            <textarea id="inclusionField{{$value->id}}" name="tour_inclusions{{$value->id}}" class="form-control" style="display: none;">{{ isset($cartExperienceTP->tp_tour_inclusions) ? preg_replace($pattern, '', ($cartExperienceTP->tp_tour_inclusions)) : '' }}</textarea>
                                            <div id="inclusionContent{{$value->id}}">
                                                {!! isset($cartExperienceTP->tp_tour_inclusions) ? ($cartExperienceTP->tp_tour_inclusions) : '' !!}
                                            </div>
                                ...
                                <?php /*}*/ ?>
                                 <?php if(!empty($cartExperienceTP->tp_services_facilities)){ ?> 
                                <div class="tc_box_wrapper">
                                    <div class="tc_box">
                                        ...
                                        <div class="body">
                                            ...
                                            <textarea id="servicesField{{$value->id}}" name="services_facilities{{$value->id}}" class="form-control" style="display: none;">{{ isset($cartExperienceTP->tp_services_facilities) ? preg_replace($pattern, '', ($cartExperienceTP->tp_services_facilities)) : '' }}</textarea>
                                            <div id="servicesContent{{$value->id}}">
                                                {!! isset($cartExperienceTP->tp_services_facilities) ? ($cartExperienceTP->tp_services_facilities) : '' !!}
                                            </div>
                                ...
                                <?php } ?>
                               <?php if(!empty($cartExperienceTP->tp_house_keeping)){ ?> 
                                <div class="tc_box_wrapper">
                                    <div class="tc_box">
                                        ...
                                        <div class="body">
                                            <textarea id="house_keepingField{{$value->id}}" name="house_keeping{{$value->id}}" class="form-control" style="display: none;">{{ isset($cartExperienceTP->tp_house_keeping) ? preg_replace($pattern, '', ($cartExperienceTP->tp_house_keeping)) : '' }}</textarea>
                                            <div id="house_keepingContent{{$value->id}}">
                                                {!! isset($cartExperienceTP->tp_house_keeping) ? ($cartExperienceTP->tp_house_keeping) : '' !!}
                                            </div>
                               ...
                               <?php if(!empty($cartExperienceTP->tp_important_information)){ ?> 
                                <div class="tc_box_wrapper">
                                    <div class="tc_box">
                                        ...
                                        <div class="body">
                                            <textarea id="important_informationField{{$value->id}}" name="important_information{{$value->id}}" class="form-control" style="display: none;">{{ isset($cartExperienceTP->tp_important_information) ? preg_replace($pattern, '', ($cartExperienceTP->tp_important_information)) : '' }}</textarea>
                                            <div id="important_informationContent{{$value->id}}">
                                                {!! isset($cartExperienceTP->tp_important_information) ? ($cartExperienceTP->tp_important_information) : '' !!}
                                            </div>
                                        </div>
