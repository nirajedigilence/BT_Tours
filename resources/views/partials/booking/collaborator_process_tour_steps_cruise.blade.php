...
.download_file img{height: 62px;
   ...
   .orangeLink {
    ...
    <div class="_contentBooking">
            ...
            <div class="filters">
                ...
                <div class="filters_dropdown">
                    ...
                    <div class="dropdown">
                        ...
                        <?php } else { ?> 
                            <form action="{{ route('account-cruise-collaborator') }}" id="filterForm">
                        <?php } ?>
                ...
                <ul class="active_filters">
                    <li class="label">Active filters:<br>
                        <a href="{{ route('account-cruise-collaborator') }}" style="color: orange;font-weight: normal;text-decoration: underline !important;float: left;">reset</a>
                    </li>
                    ...
                    <?php }else{ ?>
                        <li>Ship <a href="javascript:;" id="hotelRemove"><span>x</span></a></li>
                    <?php } ?>
        ...
        <style type="text/css">
         ...
         <div class="middleCol_row header">
                ...
                <div class="sorting column <?php echo (isset($_GET['hotel']) && $_GET['hotel'] == 'no') ? 'hide' :''; ?>" data-sorting_type="desc" data-column_name="hotel_name" style="cursor: pointer">
                    Ship Name <span class="sort-sp" id="hotel_name_icon"><i class="fa fa-sort" aria-hidden="true"></i></span>
                </div>
        ...
        <div id="ctour_list">
            @include ('partials.booking.current_tour_list_cruise')
...
$(document).ready(function(){
     function fetch_data(sort_type, sort_by, stage, ref_no,next_step,next_step_due,collaborator,experience,hotel,tour_no,month,date_from,date_to)
     {
        $('.loader').show();
      $.ajax({
       url:"/fetch_current_tour?sortby="+sort_by+"&sorttype="+sort_type+"&stage="+stage+"&ref_no="+ref_no+"&next_step="+next_step+"&next_step_due="+next_step_due+"&collaborator="+collaborator+"&experience="+experience+"&hotel="+hotel+"&tour_no="+tour_no+"&month="+month+"&date_from="+date_from+"&date_to="+date_to,
       success:function(data)
       {
        $('#ctour_list').html('');
     ...
     $('body').on('click', '.sorting', function(){
      ...
      $('body').on('click', '#submitBtnExport', function(e){
      ...
      $('body').on('click', '#submitBtnExportAll', function(e){
