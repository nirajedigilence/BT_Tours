                ...
                <div class="tourInfoCont">
                    ...
                    <div class="infoBox">
                        ...
                        <span class="right">
                            ...
                            if($canx_days > 0){
                                echo date('d/m/Y',strtotime('-'.$canx_days.' days', strtotime($item->date_from)));
                            }else{
                                echo '---';
                            } ?>
                        </span>
                    ...
                    <div class="infoBox">
                        ...
                        <span class="right">
                            ...
                            <?php echo !empty($canx_days)?$canx_days:'---'; ?>
                        </span>
                    </div>
                    <div class="infoBox">
                    ...
                    <div class="infoBox">
                        ...
                        <span class="right"> @if(optional($item->tourStatuses->last())->id == 1)
                                                Exp Tour Confirmation
                                         @elseif(optional($item->tourStatuses->last())->id == 2)
                                            URL
                                         @elseif(optional($item->tourStatuses->last())->id == 3)
