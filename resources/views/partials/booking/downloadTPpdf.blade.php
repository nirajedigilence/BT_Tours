...
DB::connection('mysql_veenus')->table('hotel_dates')->select('h.id','h.name','h.street','h.city','h.country','h.postcode','h.phone')->leftjoin('hotels as h','h.id','=','hotel_dates.hotel_id')->where('hotel_dates.id', $value->hotel_date_id)->first();
            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td >
                        <h4  style="font-family: 'Montserrat', sans-serif;  font-size: 14px; font-weight: 700; line-height: 5px; text-align: left; color: #14213D; padding: 0px 0px;text-align: center;">{{$hotel->name}}</h4>
                        <p style="font-family: 'Montserrat', sans-serif;  font-size: 12px; font-weight: 400; line-height: 5px; text-align: left; color: #526170; text-align: center;">{{ date("D d M", strtotime($value->date_from)) }} - {{ date("D d M 'y", strtotime($value->date_to)) }} ( {{ $value->nights }} @if($value->nights > 1) nights @else night @endif )</p>
                    </td>
                </tr>
            </table>
            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <td bgcolor="#FFFFFF" style="background-color: #FFFFFF; border: solid 1px #CFCFCF; -moz-box-shadow: 0px 3px 6px #00000029; -webkit-box-shadow: 0px 3px 6px #00000029; box-shadow: 0px 3px 6px #00000029;">
                                    ...
                                    <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            <td style="font-family: 'Montserrat', sans-serif; font-size: 14px;  line-height: 15px; text-align: left; color: #14213D; padding: 10px 10px;">
                                                <ul>
                                                <li>Hotel Name: <strong><?php echo (!empty($value) ? $hotel->name : ''); ?></strong></li>
            ...
            <!-- END OF FULL WIDTH SECTION -->
            <?php $cartExperienceTP = App\Models\Cms\CartExpericenceTP::where("cart_exp_id", $cart_experience->id)->where("exp_date_id", $value->id)->first(); ?>
            <!-- START OF FULL WIDTH SECTION -->
            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td >
                        <h4  style="font-family: 'Montserrat', sans-serif;  font-size: 14px; font-weight: 700; line-height: 18px; text-align: left; color: #14213D; padding: 5px 5px;text-align: center;">Experiences</h4>
