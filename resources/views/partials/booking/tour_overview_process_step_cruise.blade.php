...
DB::connection('mysql_veenus')->table('experience_dates')->selectRaw('experience_dates.id,ship_dates.free_srs')->join('ship_dates','ship_dates.id','=','experience_dates.hotel_date_id')->where('experience_dates.dates_rates_id', $date_rate_id)->first();
               ?>
            ...
            <div class="tour_summary_container">
                ...
                <div class="tabs_wrapper">
                    <ul class="tabs" style="margin-bottom: 0px;">
                        ...
                        <li href=".tab3" style="color: #ccc;pointer-events: none;">
                            Hotel
                        </li>
                    ...
                    <div class="todo_list">
                         @foreach($newarr as $its)
                            @if(!empty($its->pivot))
                                    ...
                                    ?>
                                    <div class="todo @if($its->id == '1') _docusignStepCls @elseif($its->id == '4' || $its->id == '6') rais @else stepItemSquareActive @endif @if($its->pivot->completed == 1) completed @elseif($its->pivot->due_date < Carbon\Carbon::now()) overdue @endif @if($item->tourStatusesCruise->last()->id == $its->id)) active @endif"  data-id="{{ $item->id }}" data-step="{{ $its->id }}" id="reloadInfo{{$item->id}}"  data-urls="{{ route('cruise-docusign', $item->id) }}" data-tour="{{ route('show-tourpack', $item->id) }}" data-tab="superuser" <?php echo $style; ?>>
...
DB::connection('mysql_veenus')->table('experience_cruise_dates_rates')->where('id', $item->cruise_dates_rates_id)->where('deleted_at', null)->first();
                                                   ...
                                                   if(!empty($experience_dates_rates) && $its->id == 1){ ?>
                                                         <a class="hcDateClick" data-id="{{!empty($ship_dates->id)?$ship_dates->id:''}}" data-exid="{{$item->experiences_id}}" style="color: #FCA311;font-size: 15px;" href="javascript:void(0)" >HC</a><?php 
                                                    /*}*/
                                                }
                                                   ...
                                                   <!--  <a class="cta" href="{{route('edit-deposit-amount', $item->id)}}/?type=deposit" >
                                                    ...
                                                    {*/
                                                        ...
                                                        ?>
                                                          ...
                                                          <a class="cta" style="color: #FCA311;font-size: 15px;"  data-fancybox data-type="ajax" data-src="" href="/edit-deposit-amount-cruise/{{$item->id}}" >
                                                             Edit Amount
                                                            </a><br/>
                                                            <a class="cta total" href="/completed_tour_state_cruise?cart_experiences_id={{$item->id}}&tour_statuses_id=4&step4=1"  style="color: #FCA311;font-size: 15px;"> Skip Deposit</a>
                                                   ...
                                                   <!--  <a class="cta" href="{{route('edit-deposit-amount', $item->id)}}/?type=deposit" >
                                                    ...
                                                    {*/
                                                        ...
                                                        ?>
                                                          ...
                                                          <a class="cta" style="color: #FCA311;font-size: 15px;"  data-fancybox data-type="ajax" data-src="" href="/edit-deposit-amount2-cruise/{{$item->id}}" >
                                                             Edit Amount
                                                            </a><br/>
                                                            <a class="cta total" href="/completed_tour_state_cruise?cart_experiences_id={{$item->id}}&tour_statuses_id=6&step6=1"  style="color: #FCA311;font-size: 15px;"> Skip Deposit</a>
                                                         <!-- <a class="cta" style="color: #FCA311;font-size: 15px;" href="{{route('create-invoice', $item->id)}}/?type=deposit&page=overview" >
                                                          <?=!empty($item->xero_deposit_invoice_id)?'Update':'Raise'?> Deposit
                                                        </a> -->
                                                       <?php
                                                ...
                                                if(!empty($experience_dates_rates) && $its->id == 8){
                                                    ...
                                                    {*/
                                                       ...
                                                       ?>
                                                        ...
                                                        <br/>
                                                         <a class="cta total" href="/completed_tour_state_cruise?cart_experiences_id={{$item->id}}&tour_statuses_id=8&step8=1"  style="color: #FCA311;font-size: 15px;"> Skip Invoice</a>
                                                       <?php } else {
                                                        ?>
                                            ...
                                            <div class="excerpt">
                                                <p>
                                                    ...
                                                    @elseif($its->id == 9)
                                                        ...
                                                        <a href="javascript:;"  style="width: 59%;float: left;" data-tour="{{ route('show-cd-list', $item->id) }}" data-tab="collaborator" class="cta @if($its->id == '1') docusignStepCls @elseif($its->id == '9') tourPackBox  @endif"><i class="fas fa-file-pdf fa-3x" style="<?=(empty($sign_name)?'color: gray':'color: #FCA311;')?>"></i><br><span style="color: gray;font-weight: bold;">CD</span></a>
                                                        <a href="javascript:;"  style="width: 35%;float: left;" data-tour="{{ route('show-cp', $item->id) }}" data-tab="collaborator" class="cta @if($its->id == '1') docusignStepCls @elseif($its->id == '9') <?=(!empty($sign_name)?'tourPackBox':'tourPackBox')?>  @endif"><i class="fas fa-file-pdf fa-3x" style="<?=(!empty($experience_dates_rates->mark_as_completed_tp)?'color: #FCA311;':'color:gray;')?>"></i><br><span style="color: gray;font-weight: bold;">CP</span></a>
                                           ...
                                           <?php 
                                            ...
                                            <div class="ctas">
                                                ...
                                                @else
                                                    <a href="javascript:;" class="cta @if($its->id == '1') docusignStepCls  @elseif($its->id == '7') editGuestList  @endif" data-tab="superuser"> @if($its->id == '7') Update numbers @else edit @endif</a>
                                                    <a href="javascript:;" class="cta sendAlert">send alert</a>
                                                @endif
                                            </div>
                            ...
                            <div class="column w_flex">
                                ...
                                <div class="white_box">
                                    ...
                                    <div class="heading with_cta">
                                        Hotel outbound
                                         <?php if(empty($check_hotel_outbound)){ ?>
                                            <a class="cta tourOverviewButton" data-fancybox data-type="ajax" data-src="" href="/change-hotel-cruise/{{$item->id}}/2" id="_reloadInfo{{$item->id}}">Change</a>
                                        <?php } else { ?> 
                                            <a class="cta tourOverviewButton" data-fancybox data-type="ajax" data-src="" href="/change-hotel-cruise-edit/{{$item->id}}/2" id="_reloadInfo{{$item->id}}">Change</a>
                                        <?php  }?>
                                    ...
                                    <div class="box_listings">
                                        ...
                                        if(isset($item->cartExperiencesToHotelCruiseOutbound))
                                        {
                                         foreach ($item->cartExperiencesToHotelCruiseOutbound as $keyEE => $_valueEE) { 
...
DB::connection('mysql_veenus')->table('hotels')->selectRaw('id,name,address,contact_number,contact_name,phone,street,city,country,postcode')->where("id", $_valueEE->hotel_id)->first();
                                         ...
                                         ?>
                                         <div class="row"> 
                                            <div style="width: 95%;" class="mb-3 listing showExep{{$cnt}} bookingdiv{{$hotel_detail->id}} {{$addclss}}">
                                                <div class="tick"></div>
                                                <div class="sub_heading">
                                                        Hotel {{$cnt}} <i class="fas fa-caret-up"></i>
                                                    </div>
                                                ...
                                                <div class="row m-1">
                                                    <a class="add_booking" data-fancybox="" data-type="ajax" data-src="" href="<?='/add-bookings/'.$hotel_detail->id.'/'.$item->id?>">
                                                    <?php 
                                                    if(!empty($_valueEE->date) || !empty($_valueEE->group_name)){
                                                        echo "Edit booking";
                                                    }else{
                                ...
                                <div class="white_box">
                                    ...
                                    <div class="heading with_cta">
                                        Hotels inbound
                                        <?php if(empty($check_hotel_inbound)){ ?>
                                            <a class="cta tourOverviewButton" data-fancybox data-type="ajax" data-src="" href="/change-hotel-cruise/{{$item->id}}/1" id="_reloadInfo{{$item->id}}">Change</a>
                                        <?php } else { ?> 
                                            <a class="cta tourOverviewButton" data-fancybox data-type="ajax" data-src="" href="/change-hotel-cruise-edit/{{$item->id}}/1" id="_reloadInfo{{$item->id}}">Change</a>
                                        <?php  }?>
                                    ...
                                    <div class="box_listings">
                                        ...
                                        if(isset($item->cartExperiencesToHotelCruiseInbound))
                                        {
                                         foreach ($item->cartExperiencesToHotelCruiseInbound as $keyEE => $_valueEE) { 
                    ...
                    <div class="todo_list">
                         @foreach($newarr as $its)
                            @if(!empty($its->pivot))
                                    ...
                                    ?>
                                        <?php //if($its->id == '1'){ ?>
                                    <div class="todo @if($its->id == '1') _docusignStepCls @elseif($its->id != '5' && $its->id != '8' && $its->id != '9') stepItemSquareActive @endif @if($its->pivot->completed == 1) completed @elseif($its->pivot->due_date < Carbon\Carbon::now()) overdue @endif @if($item->tourStatusesCruise->last()->id == $its->id)) active @endif"  data-id="{{ $item->id }}" data-step="{{ $its->id }}" id="reloadInfo{{$item->id}}"  data-urls="{{ route('cruise-docusign', $item->id) }}" data-tour="{{ route('show-tourpack', $item->id) }}" data-tab="collaborator" <?php echo $style; ?>>
                                            ...
                                            <div class="ctas">
                                                ...
                                                @elseif($its->id != '9')
                                                    ...
                                                    <a href="javascript:;" class="cta @if($its->id == '1') docusignStepCls @elseif($its->id == '3' || $its->id == '4' || $its->id == '6') editTracking @elseif($its->id == '7') editGuestList @endif" data-tab="collaborator">@if($its->id == '7') Update numbers @else edit @endif</a>
                                                    @else
                                                    <a href="#" class="cta">download</a>
                                                    @endif
                                                @endif
                                    ...
                                    <div class="column w_33">
                                        ...
                                        <div id="other" class="flex">
                                            ...
                                            <div class="box green">
                                                ...
                                                <div class="ctas">
                                                    <a class="cta tourOverviewButton" data-fancybox data-type="ajax" data-src="" href="{{ route('change-rooms-cruise', $item->id) }}" id="_reloadInfo{{$item->id}}">Update numbers</a>
                                                </div>
...
<div style="display: none;">
        @foreach($items as $key => $cartItem)
            ...
            $totalGuestS = $sngSCntS + $dblSCntS + $twnSCntS + $trpSCntS + $qrdSCntS ;
                            ...
                            <form method="POST" action="{{ route('process-tour-steps-cruise.ajax') }}" class="ajax" enctype="multipart/form-data">
                                {{ csrf_field() }}
                               ...
                               @elseif(optional($itemStatus)->id == 2)
                                ...
                                @elseif(optional($itemStatus)->id == 11 || optional($itemStatus)->id == 12 || optional($itemStatus)->id == 13)
                                    <?php
                                    ...
                                    <a class="cta tourOverviewButton" data-fancybox data-type="ajax" data-src="" href="{{ route('change-rooms-cruise', $item->id) }}" style="font-size:700;color:orange;" id="_reloadInfo{{$item->id}}">Update numbers</a>    
                                 @elseif(optional($itemStatus)->id == 3)
                                <label for="step5">Step 3</label>
                                <div class="_inputRow">
                                    <input type="hidden" name="step3" value="1" placeholder="Please Enter a Step 5">
                                    <button type="submit" data-step="{{ optional($itemStatus)->id }}" class="stepSubmitButton btn btn-success">Mark as Completed</button>
                                </div>
                                ...
                                @elseif(optional($itemStatus)->id == 9)
                                   ...
                                   <!--  <input class="fileuplodaed" type="file" name="fileupload" action="{{ route('process-tour-steps-cruise.ajax') }}" cart_experiences_id="{{ $item->id }}" tour_statuses_id="{{ optional($itemStatus)->id }}" accept=".pdf, .docx, .doc"> -->
                                    <!-- <div class="inputRow">
...
$("body").on("change", '.sk_small_text', function(e) {
    ...
    if(sum <= max){
        if(value < minvalue){
            $(this).val(minvalue);
            alert('To remove a person from this Tour, please visit the Update numbers and remove from this section.');
        }
    }else{
        $(this).val(minvalue);
