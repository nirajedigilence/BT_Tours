...
DB::connection('mysql_veenus')->table('hotel_dates')->where('hotel_id', $hotel->id)->where('hotel_id', $hotel->id)->where('id', $hotel_book_date_id)->get()->toArray();
                                        ...
                                        <div class="rt_row euro_colunm" <?=(!empty($hotel->preferred_currency) && ($hotel->preferred_currency == '2'))?'':'style="display:none"'?>>
                                            ...
                                            <div class="rt_column no-boder">
                                               <input type="text" class="notClickedCls hdioCls form-control numbercls" id="RateDBBE{{$cnts}}" placeholder="Sgl Rate pppn &#8364;" value="{{ $value->rate_dbb_euro}}" name="dates_edit[{{ $value->id }}][rate_dbb_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                              <input type="text" class="notClickedCls hdioCls form-control numbercls" id="RateDBL{{$cnts}}" placeholder="Cbl Rate pppn &#8364;" value="{{ $value->rate_dbl_euro }}" name="dates_edit[{{ $value->id }}][rate_dbl_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                               <input type="text" class="notClickedCls hdioCls form-control numbercls" id="RateTWNE{{$cnts}}" placeholder="Twm Rate pppn &#8364;" value="{{ $value->rate_twn_euro }}" name="dates_edit[{{ $value->id }}][rate_twn_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                                <input type="text" class="notClickedCls hdioCls form-control numbercls" id="RateTRNE{{$cnts}}" placeholder="Trp Rate pppn &#8364;" value="{{ $value->rate_trp_euro }}" name="dates_edit[{{ $value->id }}][rate_trp_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                                <input type="text" class="notClickedCls hdioCls form-control numbercls" id="RateQRDE{{$cnts}}" placeholder="Qrd Rate pppn &#8364;" value="{{ $value->rate_qrd_euro }}" name="dates_edit[{{ $value->id }}][rate_qrd_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                                <input type="text" class="notClickedCls hdioCls form-control numbercls" id="RateDRE{{$cnts}}" placeholder="Dr Rate pppn &#8364;" value="{{ $value->rate_dr_euro }}" name="dates_edit[{{ $value->id }}][rate_dr_euro]" required>
                                            </div> 
                                         ...
                                         <div class="rt_row euro_colunm" <?=(!empty($hotel->preferred_currency) && ($hotel->preferred_currency == '2'))?'':'style="display:none"'?>>
                                            ...
                                            <div class="rt_column no-boder">
                                              <input type="text" class="notClickedCls hdioCls form-control numbercls" id="SRSDBL{{$cnts}}" placeholder="SRS Dbl Rate pppn &#8364;" value="{{ $value->date_srs_dbl_euro }}" name="dates_edit[{{ $value->id }}][date_srs_dbl_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                               <input type="text" class="notClickedCls hdioCls form-control numbercls" id="SRSTWNE{{$cnts}}" placeholder="SRS Twn Rate pppn &#8364;" value="{{ $value->date_srs_twn_euro }}" name="dates_edit[{{ $value->id }}][date_srs_twn_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                                <input type="text" class="notClickedCls hdioCls form-control numbercls" id="SRSTRNE{{$cnts}}" placeholder="SRS Trd Rate pppn &#8364;" value="{{ $value->date_srs_trp_euro }}" name="dates_edit[{{ $value->id }}][date_srs_trp_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                                <input type="text" class="notClickedCls hdioCls form-control numbercls" id="SRSQRDE{{$cnts}}" placeholder="SRS Qrd Rate pppn &#8364;" value="{{ $value->date_srs_qrd_euro}}" name="dates_edit[{{ $value->id }}][date_srs_qrd_euro]" required>
                                            </div>

                                            <div class="rt_column no-boder">
                                                <input type="text" class="notClickedCls hdioCls form-control numbercls" id="SRSDRE{{$cnts}}" placeholder="SRS Dr Rate pppn &#8364;" value="{{ $value->date_srs_dr_euro }}" name="dates_edit[{{ $value->id }}][date_srs_dr_euro]" required>
                                            </div> 
                                        ...
                                        <div class="rt_row">
                                           ...
                                           <input type="text" class="notClickedCls hdioCls form-control numbercls" id="freeSRS{{$cnts}}" placeholder="" value="{{ number_format($value->free_srs,2) }}" name="dates_edit[{{ $value->id }}][free_srs]" required>
                                            </div>
