...
DB::connection('mysql_veenus')->table('experience_dates_rates')->selectRaw('experience_dates_rates.id,experience_dates_rates.mark_as_completed_etc')
                             ...
                             ?>
                <div class="hotelDatesMainCls box editCls" data-date-id="{{ $hotel_book_date_id}}" data-id="{{$cnts}}" data-cart_id="<?=!empty($hotel_cart_list[0]->cart_id)?$hotel_cart_list[0]->cart_id:''?>">
