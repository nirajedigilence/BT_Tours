    ...
    <div class="row">
        <div class="header_part">
            ...
            <div class="head_part_two" style="width: 50%;">
                <a class="orangeLink btn pullright" href="javascript:;">Complete</a>
            </div>
        </div>
            ...
            <div class="contentBooking">
                ...
                <div class="rightSidebarDiv">
                    ...
                    <div class="sidebar_part_one">
                        ...
                        <span class="scoreperc" style="color: #000; font-size: 40px;">30</span>
                    </div>
                    ...
                    <div class="sidebar_part_four" style="text-align: center;">
                        ...
                        <label  class="sideSubLastTitleCls"><i class="fas fa-pound-sign"></i>374.00pp</label>
                    </div>
                </div>
            </div>
        </div>
