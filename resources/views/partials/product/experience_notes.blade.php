        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="cmtTitleCls">
                    <div class="ctMainCls">
                        {{$ProductsExperience->name}}
                    </div>
                </div>
            </div>
            <div class=" hotelNotesSec">
                <div class="row">
                    <?php foreach ($productExperienceNotesList as $key => $value) { ?>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="hidden" name="productHotelIdsCls" class="productHotelIdsCls" value="{{$products_experience_id}}" >
                </div>
            </div>
