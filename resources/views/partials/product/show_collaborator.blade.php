{!! Form::open(array('route' => 'prototypes-share-update','method'=>'POST', 'enctype' => 'multipart/form-data', 'class'=>'storePrototypeForm', 'id'=>'storePrototypeForm')) !!}    
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="protoid" name="protoid" value="{{ $protoid }}">
                </div>
            </div>
                        ...
                        <div class="checkarea_part">
                            <label class="checkbox_div">
                                ...
                                if (in_array($user->id, $productShareArray)){ ?>
                                    <input type="checkbox" name="users[{{$user->id}}]" value="1" checked="" class="custom_chkbox"> 
                                <?php }else{ ?>
                                    <input type="checkbox" name="users[{{$user->id}}]" value="1" class="custom_chkbox"> 
                                <?php } ?>
                                    {{$user->name}}
    ...
    <div class="modal-footer">
        ...
        {{-- <a href="javascript:;" class="btn btn-primary create RemoveSectionCls">Share</a>                 --}}
