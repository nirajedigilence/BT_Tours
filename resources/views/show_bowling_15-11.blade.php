...
DB::connection('mysql')->table('countries')->where('id', $row->countryAreas[0]->countries_id)->first();
                                ?>
                                <a href="{{ route('search.main') }}?view=grid&experience_categories_id[]={{$row->experienceCategories[0]->id}}&country_areas_id[]={{$row->countryAreas[0]->id}}"><?php echo $country->name; ?></a>
                                <span class="separator"><i class="fas fa-chevron-right"></i></span>
                                <a href="{{ route('search.main') }}?view=grid&experience_categories_id[]={{$row->experienceCategories[0]->id}}&country_areas_id[]={{$row->countryAreas[0]->id}}"><?php echo $row->countryAreas[0]->name; ?></a>
                                <span class="separator"><i class="fas fa-chevron-right"></i></span>
                                <?php
                            }
                            ?>
                                    ...
                                    <div class="darkBlueHolder">
                                       <div class="prices" style="margin-bottom:15px;">
                                        ...
                                        <div class="actionsRow">
                                            ...
                                            <button id="addToCart" <?php echo (($date_available != 'yes') ? 'style="background:lightgrey;pointer-events: none;"' : ''); ?>><i class="fas fa-cart-arrow-down"></i> Contact Us</button>
            ...
            <div class="tabsContant" id="tabsContant">
                ...
                <div class="container" id="datesTab" style="display: none;">
                    <h3>Dates & Rates</h3>
                    <div class="dates">
                        <div class="datesCont" style="width:100%;">
                                ...
                                @foreach ($row->ExperienceDateAdditionalTexts as $rec)
                                    <div class="">
                                        <div class="left">
                                            ...
                                            <div class="excerpt" style="font-weight: 700;">{!! nl2br($rec->text) !!}</div>
                                        </div>
                                    </div>
                                @endforeach
                            @endif
