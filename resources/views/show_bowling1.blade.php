...
@section('content')
    ...
    <style type="text/css">
        ...
        .singlePropertyContainer .tabsContant .container .hotels .hotel .hotelsSwiper .swiper-container .swiper-button-prev::after,
        .singlePropertyContainer .tabsContant .container .hotels .hotel .hotelsSwiper .swiper-container .swiper-button-next::after {
            font-size: 12px;
            color: #fff;
            font-weight: 600;
        }
        ...
        .singlePropertyContainer .tabsContant .container .hotels .hotel .hotelsSwiper .swiper-container .swiper-button-next,
        .singlePropertyContainer .tabsContant .container .hotels .hotel .hotelsSwiper .swiper-container .swiper-button-prev {
            align-items: center;
                    ...
                    <div class="swiper-wrapper">
                        @foreach ($row->experienceImages as $image)
                            <div class="swiper-slide">
                                <img src="{{ $image_url . 'storage/' . $image->file }}"
                                    alt="@if ($image->name) {{ $image->name }} @else {{ $row->name }} @endif">
                            </div>
                        @endforeach
                    </div>
                </div>
    ...
    if (isset($row->experienceCategories) && !empty($row->experienceCategories[0])) {
                                    ?>
                            <a
                                href="{{ route('search.main') }}?view=grid&experience_categories_id[]={{!empty($row->experienceCategories[0]->id) ? $row->experienceCategories[0]->id : ''}}"><?php    echo !empty($row->experienceCategories[0]->name) ? $row->experienceCategories[0]->name : ''; ?></a>
                            <span class="separator"><i class="fas fa-chevron-right"></i></span>
                            <?php
    }
    if (isset($row->countryAreas) && !empty($row->countryAreas[0])) {
        $country =
            ...
            DB::connection('mysql')->table('countries')->where('id', $row->countryAreas[0]->countries_id)->first();
                                    ?>
                            <a
                                href="{{ route('search.main') }}?view=grid&experience_categories_id[]={{!empty($row->experienceCategories[0]->id) ? $row->experienceCategories[0]->id : ''}}&country_areas_id[]={{!empty($row->countryAreas[0]->id) ? $row->countryAreas[0]->id : ''}}"><?php    echo $country->name; ?></a>
                            <span class="separator"><i class="fas fa-chevron-right"></i></span>
                            <a
                                href="{{ route('search.main') }}?view=grid&experience_categories_id[]={{!empty($row->experienceCategories[0]->id) ? $row->experienceCategories[0]->id : ''}}&country_areas_id[]={{!empty($row->countryAreas[0]->id) ? $row->countryAreas[0]->id : ''}}"><?php    echo $row->countryAreas[0]->name; ?></a>
                            <span class="separator"><i class="fas fa-chevron-right"></i></span>
                            <?php
    }
                                ?>
                        ...
                        <div class="right">
                            ...
                            <a class="socials" href="https://www.facebook.com/BowlingTours"><i
                                    class="fab fa-facebook-square"></i></a>
                            <!-- <a class="socials" href="https://twitter.com/"><i class="fa-brands fa-square-x-twitter"></i></a> -->
                            <a class="socials" href="https://www.instagram.com/bowlingtours/"><i
                ...
                <div class="container">
                    <div class="infoPriceWrapper">
                        <div class="left">
                            ...
                            $row->ExperienceHotels[0]->hotelAmenities->count() > 0) --}}
                            @if ($row->getExperiencesToInclusionsBlueBar->count() > 0)
                                    ...
                                    if (isset($valueEI->getIconList) && !empty($valueEI->getInclusion->name)) {
                                                            ...
                                                            <li style="padding-left: 45px;">
                                                                {!! $valueEI->getIconList->icon !!}
                                                                {{ !empty($valueEI->getInclusion->name) ? $valueEI->getInclusion->name : '' }}
                                                            </li>
                                                            <?php        }
                                } ?>
                                                            {{-- <li>
                                ...
                                <div class="activityRow">
                                    ...
                                    <div class="rightA">
                                        ...
                                        <div class="activeBoxRow">
                                            <div class="activeBox <?php echo ($row->mobility >= 1) ? 'filled' : ''; ?>">
                                            </div>
                                            <div class="activeBox <?php echo ($row->mobility >= 2) ? 'filled' : ''; ?>">
                                            </div>
                                            <div class="activeBox <?php echo ($row->mobility >= 3) ? 'filled' : ''; ?>">
                                            </div>
                                            <div class="activeBox <?php echo ($row->mobility >= 4) ? 'filled' : ''; ?>">
                                            </div>
                                            <div class="activeBox <?php echo ($row->mobility >= 5) ? 'filled' : ''; ?>">
                                            </div>
                                            <span class="iconHolder">
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <strong>Level 3</strong> – Lots of steps and active walking, cobbled
                                                    stones</br>
                                                    <strong>Level 4</strong> – Active walking, lots of steps, narrow
                                                    staircases and/or difficult terrains</br>
                                                    <strong>Level 5</strong> – Long and intensive walking conditions (e.g.
                                                    rambling)
                                                </div>
                                            </span>
                                        </div>
                            ...
                            @if(empty($is_bt_user))
                                ...
                                /*if(!empty($collaborators)){
                                    ...
                                    foreach ($exp_dates as $date_row) {
                                                                            ?>
                                                                <option data-night="{{ $date_row['nights'] }}"
                                                                    value="{{ $date_row['dates_rates_id'] }}">
                                                                    {{ date('D d M y', $date_row['date_from']) }} -
                                                                    {{ date('D d M y', $date_row['date_to']) }} ({{ $date_row['nights']}} nights)
                                                                </option>
                                                                <?php
                                    }
                                } ?>
                                           ...
                                           $currency_symbol = '£';
                                                            ...
                                                            <div class="darkBlueHolder">
                                                                ...
                                                                <div class="actionsRow">
                                                                    ...
                                                                    <button id="enquiry_link"
                                                                        type="button"><!-- <i class="fas fa-cart-arrow-down"></i> -->
                                                                        Enquire</button>
                                                    ...
                                                    <div class="priceBox">
                                                        ...
                                                        <form id="addToCartForm1">
                                                            ...
                                                            <input type="hidden" name="created_by"
                                                                value="{{isset($_GET['bt_tour']) ? $_GET['bt_tour'] : ''}}">
                                                            <input type="hidden" name="club_name" id="club_name"
                                                                value="">
                                        ...
                                        if (!empty($date_row['hotels'][0])) {
                                            foreach ($date_row['hotels'][0] as $hrow) {
                                                $hotel_array[] = $hrow['name'];
                                                                            ...
                                                                            ?>
                                                                                <option data-night="{{ $date_row['nights'] }}" value="{{ $date_row['dates_rates_id'] }}">{{ date('D d M y', $date_row['date_from']) }} - {{ date('D d M y', $date_row['date_to']) }} ({{ $date_row['nights']}} nights)<?php            echo " - ";
                                        echo implode(', ', $hotel_array); ?></option>
                                                                            <?php
                                    }
                                } ?>
                                                            ...
                                                            <script>
                                                                ...
                                                                $(document).ready(function () {
                                                                    ...
                                                                    $('#addToCart').on("click", function (e) {
                                                                        e.preventDefault();
                                                                        // Set club_name from the currently selected collaborator at submit time
                                                                        var selectedCollab = $('#s_collaborator_id option:selected');
                                                                        if (selectedCollab.length && selectedCollab.attr('data-name')) {
                                                                            $('#club_name').val(selectedCollab.attr('data-name'));
                                                                        }
