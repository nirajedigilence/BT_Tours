...
<div class="notIndexContainer">
    ...
    <div class="accountContainer">
        ...
        <div class="accountRow">
            <div class="leftCol">
                @include('partials.super_user_left',['open_menu' => 'invoice', 'sub_marked' => 'current_bookings_invoice_history']);
            </div>

            <div id="cartExperiencesPart">
                @include ('partials.booking.super_user_invoice_process_tour_steps', [
                                            'items' => $items,
