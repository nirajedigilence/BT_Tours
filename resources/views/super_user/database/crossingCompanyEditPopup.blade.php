...
<div class="popup_content">
    ...
    <div class="heading">
        {{isset($experience->company_name) ? $experience->company_name : 'Crossing Companies List'}}
    ...
    <form id="expData" enctype="multipart/form-data">
        ...
        <input type="button" name="submit" class="btn btn-primary mt-2" id="compnayCrossingFormSubmit" value="Submit">
    </form>
</div>
