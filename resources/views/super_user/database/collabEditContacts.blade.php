                            ...
                            <div class="form">
                                ...
                                <div class="grouped">
                                    <div class="fieldset half">
                                        ...
                                        <input type="text" name="contacts[{{$key}}][title]" maxlength="50"  class="inputt" value="{{ $value['title'] }}" data-field="title">
                                    </div>
                                    <div class="fieldset half">
                                        <label>Name</label>
                                        <input type="text" class="inputt" maxlength="50"  name="contacts[{{$key}}][name]" value="{{ $value['name'] }}" data-field="name">
                                    </div>
                                </div>
                                <div class="grouped">
                                    <div class="fieldset half">
                                        <label>Position</label>
                                        <input type="text" class="inputt" maxlength="30" name="contacts[{{$key}}][position]" value="{{ $value['position'] }}" data-field="position">
                                    </div>
                                    <div class="fieldset half">
                                        <label>Contact nr</label>
                                        <input type="text" class="inputt" maxlength="12" name="contacts[{{$key}}][contact_number]" value="{{ $value['contact_number'] }}" data-field="contact_number">
                                    </div>
                                </div>
                                <div class="grouped">
                                    <div class="fieldset half">
                                        <label>Email</label>
                                        <input type="text" class="inputt" maxlength="40" name="contacts[{{$key}}][email]" value="{{ $value['email'] }}" data-field="email">
                                    </div>
                                    <div class="fieldset half">
                                        <label>Short note</label>
                                        <input type="text" maxlength="100"  class="inputt" name="contacts[{{$key}}][short_note]" value="{{ $value['short_note'] }}" data-field="short_note">
                                    </div>
                                </div>
                                <div class="grouped">
                                    <div class="fieldset half">
