...
<div class="popup_content">
    ...
    <form id="hotelData">
        <div class="sections">
            ...
            <input type="hidden" name="hotel_detail_id" value="{{ isset($hotelDetails->id) ? $hotelDetails->id : '' }}">
            <input type="hidden" name="hotel_id" value="{{ $hotelDetails->id }}">
            <?php
            if(isset($hotelDetails->contacts) && !empty($hotelDetails->contacts)){
                $unserialize = unserialize($hotelDetails->contacts);
