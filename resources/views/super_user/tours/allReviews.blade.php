                            ...
                            <table id="myTable" class="table">
                                <thead>
                                    <tr class="headerBooking">
                                        ...
                                        <th>Hotels</th>
                                        <th>Tour Date</th>
                                        <th class="visible">Reviewed By</th>
...
DB::connection('mysql_veenus')->table('carts')->selectRaw('carts.id,users.name')->join('users','carts.user_id','=','users.id')->where('carts.id', $v['carts_id'])->first();
                                             $hasreview = 'yes';
                                         /*   if(!empty($v['reviews'])){
                                                $hasreview = 'yes';
                                                ...
                                                ?>
                                               <tr data-id="{{ $v['id'] }}" class="openBooking" id="openBooking-{{ $v['id'] }}">
                 ...
                 if(!empty($reviews)){
                    foreach($reviews as $k => $v){
                       ...
                       /* foreach ($v['reviews'] as $key => $value) {
                        ...
                        $hotels = implode(', ', array_column($submitted_review['hotels'], 'name'));*/
                        ?>
                        <div class="bookingForm" id="rightColInfo-{{ $v['id'] }}">
                        ...
                        <div class="hotelSecSide15">
                            <div class="text-center">
                                <a href="{{ route('allDriverReviews', $v['cart_experience_id']) }}" class="enableProductCls">View Driver Review</a>
                            </div>
                        </div>
                         <div class="hotelSecSide15">
                            <div class="text-center">
                                <a href="{{ route('tours-experiences', $v['id']) }}" class="enableProductCls">View Guest Review</a>
                            </div>
                        </div>
