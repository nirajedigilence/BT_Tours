...
class ExperiencesController extends Controller
{
    ...
    public function search_old(Request $request)
    {
        ...
        $url = getenv('IMAGE_URL') . 'api/search_exp';
        $client = new Client();
        ...
        //get country
        $url = getenv('IMAGE_URL') . 'api/get_countries';
        $client = new Client();
        ...
        //get categories
        //get country
        $url = getenv('IMAGE_URL') . 'api/get_experience_categories';
        $client = new Client();
    ...
    public function search(Request $request)
    {
        ...
        $view = 'grid';
        return view('search', compact('items', 'countries', 'experienceCategories', 'country_areas_id', 'country_ar', 'view'));
    }
    ...
    public function searchAjax(Request $request, Ajax $ajax)
    {
        ...
        /*if(isset($data["experience_categories_id"])){*/
        $experience_categories_id = !empty($data["experience_categories_id"]) ? $data["experience_categories_id"] : array();
        ...
        return $ajax
            ...
            ->view('search_part-page_content', compact('items', 'output', 'view'));
    }
