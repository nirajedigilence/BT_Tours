...
class ExperienceDate extends Model
{
    ...
    protected $table = 'experience_dates';
    ...
    */
    ...
    public function hotelAmendement()
    {
        return $this->belongsTo('App\Models\Cms\TdsHotelAmemdment','id','exp_date_id');
    }
    public function hotelAmendementCD()
    {
        return $this->belongsTo('App\Models\Cms\CDHotelAmemdment','id','exp_date_id');
    }
    /**
     * Set the date_from.
     *
