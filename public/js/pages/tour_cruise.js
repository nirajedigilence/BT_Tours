...
$(document).ready(function(){   
	...
	dropZoneFileUpload('.dropzone_map');
...
$(document).on('click', '.addHighlightsBtn', function() {
	...
	var htmls = '<div class="row">\
					<div class="col-sm-11">\
						<input name="step3[day][highlights]['+expDayRow+']['+highRow+']" id="highlights-'+expDayRow+'-'+highRow+'" class="form-control HighlightsTxtCls" required>\
					</div>\
					<div class="col-sm-1">\
						<div class="col-sm-1">\
...
$(document).on('click', '.addAmenitiesBtn', function() {
	...
	var htmls = '<div class="row">\
					<div class="col-sm-11">\
						<input name="step4['+expDayRow+'][tour_amenities][]" class="form-control HighlightsTxtCls" id="amenities-'+expDayRow+'-'+expdAmenitiesRow+'" required>\
					</div>\
					<div class="col-sm-1">\
						<div class="col-sm-1">\
							<label for="Location1">&nbsp;</label>\
			...
			<div class="partOneCls">\
				<div class="row">\
					<div class="col-sm-12">\
						<div class="form-group">\
							...
							<input name="step3[day][title]['+expDayRow+']" id="step3Title'+expDayRow+'" class="form-control" >\
						</div>\
					</div>\
					<div class="col-sm-12">\
						<div class="form-group">\
							<label for="Category1">Short Description</label>\
							<textarea name="step3[day][description]['+expDayRow+']" id="step3Description'+expDayRow+'" class="form-control" rows="7"></textarea>\
						</div>\
					</div>\
					<div class="col-sm-6">\
						<div class="form-group">\
							<label for="Category1">Departure Time</label>\
							<input type="time" name="step3[day][departure_time]['+expDayRow+']" id="step3Departure'+expDayRow+'" class="form-control" >\
						</div>\
					</div>\
					<div class="col-sm-6">\
						<div class="form-group">\
							<label for="Category1">Arrival Time</label>\
							<input type="time" name="step3[day][arrival_time]['+expDayRow+']" id="step3Arrival'+expDayRow+'" class="form-control" >\
						</div>\
					</div>\
				</div>\
				...
				<div class="brw_bx image_galller">\
					<div class="browse_btn">\
						<input type="file" name="step3[day][images]['+expDayRow+'][]" multiple="" accept="image/*" class="filesCls" data-id="214'+expDayRow+'">\
					...
					<div class="col-sm-6">\
						<div class="form-group">\
							...
							<div class="HighlightsApppend_'+expDayRow+'" >\
								<div class="row">\
									<div class="col-sm-11">\
										<input name="step3[day][highlights]['+expDayRow+'][1]" id="step3Highlights'+expDayRow+'" class="form-control HighlightsTxtCls" >\
									</div>\
									<div class="col-sm-1">\
										<div class="col-sm-1">\
											<label for="Location1">&nbsp;</label>\
				...
				<div class="row">\
					<div class="col-sm-12">\
						<div class="form-group">\
							...
							<input type="text" name="step4[cabin]['+expCabinRow+'][name]" class="form-control">\
						</div>\
					</div>\
					<div class="col-sm-12">\
					<div class="imageGalllerAppend_551'+expCabinRow+'"></div>\
						<div class="brw_bx image_galller">\
							<div class="browse_btn">\
								<input type="file" name="step4[cabin]['+expCabinRow+'][image][]" multiple="" accept="image/*" class="multiImgCls filesCls" data-id="551'+expCabinRow+'">\
								<div class="brw_user_ic">\
									<i class="far fa-images"></i>\
									<div class="brw_plus">\
										<i class="fas fa-plus"></i>\
					...
					<div class="col-sm-12">\
						<div class="form-group">\
							...
							<input type="text" name="step4[cabin]['+expCabinRow+'][size_bold]" class="form-control">\
						</div>\
					</div>\
					<div class="col-sm-12">\
						<div class="form-group">\
							<label for="Category1">Size Text</label>\
							<input type="text" name="step4[cabin]['+expCabinRow+'][size_text]" class="form-control">\
						</div>\
					</div>\
					<div class="col-sm-12">\
						<div class="form-group">\
							<label for="Category1">Description</label>\
							<textarea  name="step4[cabin]['+expCabinRow+'][description]" class="form-control" rows="7"></textarea>\
						</div>\
					</div>\
					<div class="col-sm-12">\
						<div class="form-group">\
							<label for="Category1">View</label>\
							<input type="text" name="step4[cabin]['+expCabinRow+'][view]" class="form-control">\
						</div>\
					</div>\
				</div>\
			</div>\
...
$(document).on('click', '.addCarouselBtnNew', function() {
	...
	htmls += '<div class="carousel_div">\
				...
				<div class="col-sm-12">\
					<div class="form-group">\
						...
						<input name="step5[carouselnew]['+expCarouselRowNew+'][title]" id="step6Carousel-'+expCarouselRowNew+'" class="form-control" >\
					</div>\
				</div>\
					...
					<div class="add_more_upload row">\
						<div class="col-md-3 image_galllernew">\
							<div class="form-group">\
								...
								<input type="text" maxlength="100" name="step5[carouselnew]['+expCarouselRowNew+'][image_name][]" value="" class="form-control mb-2">\
								<label>Image Order:</label>\<input type="text" maxlength="100" name="step5[carouselnew]['+expCarouselRowNew+'][image_order][]" value="" class="form-control mb-2">\
								<input type="file" name="step5[carouselnew]['+expCarouselRowNew+'][image][]" class="form-control" >\
							</div>\
						</div>\
					</div>\
					<div class="col-sm-12">\
	...
	/*<div class="brw_bx image_galller">\
		<div class="browse_btn">\
			<input type="file" class="filesCls" name="step5[carousel]['+expCarouselRow+'][image][]" data-id="'+expCarouselRow+'" id="step6CarouselImg-'+expCarouselRow+'" multiple="" accept="image/*">\
			<div class="brw_user_ic">\
				<i class="far fa-images"></i>\
				<div class="brw_plus">\
					<i class="fas fa-plus"></i>\
				...
				<div class="row">\
					<div class="col-sm-12">\
						<div class="form-group">\
							...
							<input name="step5[carousel]['+expCarouselRow+'][title]" id="step6Carousel-'+expCarouselRow+'" class="form-control" >\
						</div>\
					</div>\
				</div>\
				<div class="imageGalllerAppend_'+expCarouselRow+'"></div>\
				<div class="dropzone_gallery'+expCarouselRow+' dropzone myDropZoneCls step6_'+expCarouselRow+'_img" data-name="step5[carousel]['+expCarouselRow+'][image][]" data-cls=".step6_'+expCarouselRow+'_img"></div>\
				\
			</div>\
			<div class="clearfix"></div>\
		</div>';
...
addTourCompleteValidateOpt = {
	...
	rules: {
		...
		'step3[day][description][1]': {
			required: true,
		},
		'step3[day][departure_time][1]': {
			required: true,
		},
		'step3[day][arrival_time][1]': {
			required: true,
		},
		...
		'step4[ship][star_rating]': {
			required: true,
		},
		'step4[ship][website_link]': {
			required: true,
		},
		'step4[ship][menu_link]': {
			required: true,
		},
		'step4[ship][description]': {
			required: true,
		},
		'step4[ship][built]': {
			required: true,
		},
		'step4[ship][refurbished]': {
			required: true,
		},
		'step4[ship][cabins]': {
			required: true,
		},
		'step4[ship][passengers]': {
			required: true,
		},
		'step4[ship][crew]': {
			required: true,
		...
		'step4[ship][amenities][1]': {
			required: true,
		},
		'step4[cabin][1][name]': {
			required: true,
		},
		'step4[cabin][1][size_bold]': {
			required: true,
		},
		'step4[cabin][1][size_text]': {
			required: true,
		},
		'step4[cabin][1][description]': {
			required: true,
		},
		'step4[cabin][1][view]': {
			required: true,
		...
		'step5[carousel][1][title]': {
			required: true,
		},
		'step5[carousel][1][image][]': {
			required: true,
		},
		'step5[carousel][2][title]': {
			required: true,
		},
		'step5[carousel][2][image][]': {
			required: true,
		},
		'step7[map_url]': {
			required: true,
...
$(document).on('click', '.deleteMapImg', function() {
	var dataId = $(this).attr('data-id');
			$(this).closest('.image_galller').remove();
	$('.loader').show();    
	$.ajax({
		url: base_url+'/super-user/tour-experience/delete-map-image',
		type: 'POST',
		 // dataType: 'json',
		data: {'id':dataId},
		success: function(data) {
...
$(document).on('click', '.rightSideClk', function() {
 ...
 $(document).on('click', '#add_crosssing', function() {
	   ...
	   var htmls='';
		htmls += '<div class="row company_row mb-2">\
					<div class="col-md-2">\
						<input type="text" class="form-control" value="" name="step7[crossing]['+expCrossingRow+'][company_name]" id="built">\
						<p class="exp_error" style="display:none;color: red;">Please enter built</p>\
					</div>\
					<div class="col-md-2">\
						<input type="text" class="form-control" value="" name="step7[crossing]['+expCrossingRow+'][routes]" id="routes">\
						<p class="exp_error" style="display:none;color: red;">Please enter refurbished</p>\
					</div>\
					<div class="col-md-3">\
						<input type="text" class="form-control" value="" name="step7[crossing]['+expCrossingRow+'][est_crossing_duration]" id="est_crossing_duration">\
						<p class="exp_error" style="display:none;color: red;">Please enter passengers</p>\
					</div>\
					<div class="col-md-2">\
						<input type="text" class="form-control" value="" name="step7[crossing]['+expCrossingRow+'][crossing_times]" id="crossing_times">\
						<p class="exp_error" style="display:none;color: red;">Please enter staff to guest</p>\
					</div>\
					<div class="col-md-2">\
						<input type="text" class="form-control" value="" name="step7[crossing]['+expCrossingRow+'][inclusions]" id="inclusions">\
