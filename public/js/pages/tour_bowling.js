...
$(document).on('click', '.removeFixtureCls', function() {
    $(this).closest('.everyFixtureCls').remove();
    fixtureCntSet();
});
...
$(document).on('click', '.addFixtureBtn', function() {
    var expFixtureRow = parseInt($('.expFixtureRow').val(),10);
    $('.expFixtureRow').val(expFixtureRow+1);
    var htmls = '';
    htmls += '<div class="everyFixtureCls">\
            <div class="flwSubTitleCls">\
                <div class="row">\
                    <div class="col-sm-11 fixtureCnt">\
                        Fixture '+expFixtureRow+'\
                    </div>\
                    <div class="col-sm-1">\
                        <label for="Location1">&nbsp;</label>\
                ...
                <div class="row">\
                    <div class="col-sm-12">\
                        <div class="form-group">\
                            ...
                            <input name="step8[fixture]['+expFixtureRow+'][title]" id="step8Fixture-'+expFixtureRow+'" class="form-control" >\
                        </div>\
                    </div>\
                </div>\
                <div class="row">\
                    <div class="col-sm-12">\
                        <div class="form-group">\
                            ...
                            <textarea name="step8[fixture]['+expFixtureRow+'][fixture_text]" id="step8Fixture-'+expFixtureRow+'" class="form-control" ></textarea>\
                        </div>\
                    </div>\
                </div>\
            </div>\
...
function fixtureCntSet(){
    var cnt = 1;
    $(".fixtureCnt").each(function() {
        $(this).html('Fixture '+cnt);
        cnt++;
    });
}
