...
/*
	...
	This version was modified by  to be compatible and works with php 7.
...
{   
    ...
    $errmsg  = '<div align="justify"><p><b>Tunnel version: ' . tunnelversion . ' (php7 compatible)</b>.<p><i>This modified version was made by me.
By using this modified version you are consciously and aware of all the risks that will occur.
I am not related and shall not be liable for any consequences that may result from using this modified version.</i><p><b></b>';

    echo ( '<html><head><title>SQLyog HTTP Tunneling mod </title></head>'.           
